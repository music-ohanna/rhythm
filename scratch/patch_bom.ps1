...
$ps1Path = "scratch/patch_bom_runner.ps1"
$scriptContent = @'
$FilePath = "index.html"
$utf8NoBom = New-Object System.Text.UTF8Encoding($false)
...
# Write runner script with UTF-8 BOM
[System.IO.File]::WriteAllText($ps1Path, $scriptContent, $utf8WithBom)
Write-Host "Saved runner script with UTF-8 BOM." -ForegroundColor Cyan
