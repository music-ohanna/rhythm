...
Set-Location "c:\Users\playv\OneDrive\바탕 화면\workplace\rhythm2\final-rhythm"
...
$finalLines | Set-Content -Path "index.html" -Encoding UTF8
Write-Host "GET_CONTENT_REPLACE_SUCCESSFUL"
